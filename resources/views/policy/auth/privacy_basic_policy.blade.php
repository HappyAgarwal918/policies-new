...
<p>This document was created on <?php echo $a -> created ; ?></p>
                ...
                <pre class="link"><code id="policy_html_link">@php echo url('') @endphp/privacy-basic-policy?form-id=<?php echo $id ?></code></pre>
                ...
                <a class="ybtn ybtn-header-color" target="_blank" href="@php echo url('') @endphp/privacy-basic-policy?form-id=<?php echo $id ?>" type="button">View policy</a>
            </div>
