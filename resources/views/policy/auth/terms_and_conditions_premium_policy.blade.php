            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="page-title">
                        Terms and conditions for {{$a->website_url}}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="View" role="tabpanel">
                ...
                <p>We recommend linking to your policy directly from your {{$a->website_url}}. We host it for free and it will ensure automatic updates and compliance with the latest requirements and regulations.</p>
                <h4 class="my-3">Public link to your policy</h4>
                <pre class="link"><code id="policy_html_link">@php echo url('') @endphp/terms-and-conditions-premium-policy?form-id=<?php echo $id ?></code></pre>
                ...
                <a class="ybtn ybtn-header-color" target="_blank" href="@php echo url('') @endphp/terms-and-conditions-premium-policy?form-id=<?php echo $id ?>" type="button">View policy</a>
            </div>
            <div class="tab-pane" id="HTML" role="tabpanel">
                ...
                <p>If you rather not link to the policy directly, you may copy the HTML code of the policy directly to your <?php if ($platforms == 'Website URL'){echo'Website';}else {echo'Mobile application';}?>.</p>
...
<p>This document was last updated on <?php echo $a -> updated_at ; ?></p>
                ...
                <h4 class="my-3">Link to your policy (recommended)</h4>
                <p>We recommend linking to your policy directly from your <?php if ($platforms == 'Website URL'){echo'Website';}
        else {echo'Mobile application';}?>. We host it for free and it will ensure automatic updates and compliance with the latest requirements and regulations.</p>
                <h4 class="my-3">Public link to your policy</h4>
                <pre class="link"><code id="policy_html_link">@php echo url('') @endphp/terms-and-conditions-premium-policy?form-id=<?php echo $id ?></code></pre>
                <button class="ybtn ybtn-header-color" onclick="copyToClipboard('#policy_html_link')">Copy Link</button>
                <span id="copied-link-success" class="copied">Link Copied!</span>
