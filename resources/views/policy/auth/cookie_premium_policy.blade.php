            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="page-title">
                        Cookie policy for {{$a->website_url}}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="View" role="tabpanel">
                ...
                <pre class="link"><code id="policy_html_link">@php echo url('') @endphp/cookie-premium-policy?form-id=<?php echo $id ?></code></pre>
                ...
                <a class="ybtn ybtn-header-color" target="_blank" href="@php echo url('') @endphp/cookie-premium-policy?form-id=<?php echo $id ?>" type="button">View policy</a>
            </div>
...
&lt;p&gt;
    Cookies may be set by the Website ("first-party cookies"), or by third parties, such as those who serve content or provide advertising or analytics services on the Website ("third party
    cookies"). These third parties can recognize you when you visit our website and also when you visit certain other websites.
    <a target="_blank" href="/blogs?link=cookies">Click here</a> to learn more about cookies and how they work.
&lt;/p&gt;
&lt;h2&gt;What type of cookies do we use?&lt;/h2&gt;
