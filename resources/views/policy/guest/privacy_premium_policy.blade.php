...
@if($a->editor != NULL)
<head>
  <title>Privacy policy for {{ $a->website_url }}</title>
  <meta charset="utf-8">
    ...
    <div class="container mb-5 bg-white">
        <div class="row ">
            <div class="col-12 bg-dark">
                <h2 class="text-white fs-2  fw-bold p-3">Privacy policy for {{ $a->website_url }}</h2>
            </div>
...
<p>
    ...
    automatically accept cookies, but you can usually modify your browser setting to decline cookies if you prefer. If you choose to decline cookies, you may not be able to fully experience the features of the <?php if ($platforms == 'Website URL'){echo'Website and Services';}
        else {echo'Mobile application and services';} ?>. <a target="_blank" href="{{route('privacygenerator')}}">Click here</a> to learn more about cookies and how they work.
</p>
