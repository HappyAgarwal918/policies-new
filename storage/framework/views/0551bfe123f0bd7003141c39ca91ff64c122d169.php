...
<body>
    <div class="sidebar">
        <div class="logo-details">
          <span class="logo_name"><a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset($data->featured_image)); ?>" style="width: 100%; padding: 20px; background-color: black;"></a></span>
        </div>
        <ul class="nav-links">
            <li>
            ...
            <li>
              <a href="<?php echo e(route('admin_user')); ?>" class="<?php echo e((request()->is('user*')) ? 'active' : ''); ?>">
                <i class="fas fa-users text-white"></i><span class="links_name">Users</span>
              </a>
            </li>
            <li>
              <a href="<?php echo e(route('admin_price')); ?>" class="<?php echo e((request()->is('price*')) ? 'active' : ''); ?>">
                <i class="fas fa-dollar-sign text-white"></i><span class="links_name">Price</span>                
              </a>
            </li>
            <li>
              <a href="<?php echo e(route('admin_stripe')); ?>" class="<?php echo e((request()->is('stripe*')) ? 'active' : ''); ?>">
                <i class="fab fa-cc-stripe text-white"></i><span class="links_name">Stripe</span>
              </a>
            </li>
            <li>
              <a href="<?php echo e(route('admin_legal')); ?>" class="<?php echo e((request()->is('legal*')) ? 'active' : ''); ?>">
                <i class="fas fa-balance-scale text-white"></i><span class="links_name">Legal</span>
              </a>
            </li>
            <li>
              <a href="<?php echo e(route('admin_payment')); ?>" class="<?php echo e((request()->is('payment*')) ? 'active' : ''); ?>">
                <i class="fas fa-money-check text-white"></i><span class="links_name">Payment Status</span>
              </a>
            </li>
            <li>
              <a href="<?php echo e(route('admin_blog')); ?>" class="<?php echo e((request()->is('blog*')) ? 'active' : ''); ?>">
                <i class="fas fa-blog text-white"></i><span class="links_name">Blogs</span>
              </a>
            </li>
            <li>
              <a href="<?php echo e(route('admin.new_policy')); ?>" class="<?php echo e((request()->is('add*')) ? 'active' : ''); ?>">
            ...
            <li>                
                <form method="POST" action="<?php echo e(route('logout')); ?>">
                    ...
                    <span class="links_name"><?php echo e(__('Logout')); ?></span>
                    </a>
                </form>
            </li>
        </ul>
        ...
        <div class="profile-details">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <!-- <div class="dropdown-item p-3">
                    <img src="<?php echo e(asset('images/'.Auth::user()->profile_pic)); ?>" alt="your image" style="width:60px;" />
                    <i class="fas fa-user mr-2"></i><?php echo e(Auth::user()->username); ?>
...
</html><?php /**PATH D:\xampp7\htdocs\policies\resources\views/admin/layout.blade.php ENDPATH**/ ?>