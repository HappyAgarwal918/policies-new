    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="service-box">
                    ...
                    <div>
                        ...
                        <div class="service-details">
                            ...
                            <form action="<?php echo e(url('/acceptable-use-policy?form-id='.$id)); ?>" method="POST">
    	                        <?php echo csrf_field(); ?>
                ...
                <div class="service-box">
                    ...
                    <div>
                        ...
                        <div class="service-details">
                            ...
                            <form action="<?php echo e(url('/cookie-policy?form-id='.$id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="unique_id" value= "<?php echo $id; ?>">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="service-box">
                    <div class="service-icon">
                        <img src="<?php echo e(asset('images/cookie-consent-banner.png')); ?>" alt="">
                    </div>
                    <div>
                        ...
                        <div class="service-details">
                            ...
                            <a class="ybtn ybtn-header-color" href="<?php echo e(route('cookieconsentbanner')); ?>">Cookie consent banner</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="service-box">
                    ...
                    <div>
                        ...
                        <div class="service-details">
                            ...
                            <form action="<?php echo e(url('/disclaimer?form-id='.$id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="unique_id" value= "<?php echo $id; ?>">
                ...
                <div class="service-box">
                    ...
                    <div>
                        ...
                        <div class="service-details">
                            ...
                            <form action="<?php echo e(url('/dmca-policy?form-id='.$id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="unique_id" value= "<?php echo $id; ?>">
                ...
                <div class="service-box">
                    ...
                    <div>
                        ...
                        <div class="service-details">
                            ...
                            <form action="<?php echo e(url('/privacy-policy?form-id='.$id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="unique_id" value= "<?php echo $id; ?>">
                ...
                <div class="service-box">
                    ...
                    <div>
                        ...
                        <div class="service-details">
                            ...
                            <form action="<?php echo e(url('/refund-policy?form-id='.$id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="unique_id" value= "<?php echo $id; ?>">
                ...
                <div class="service-box">
                    ...
                    <div>
                        ...
                        <div class="service-details">
                            ...
                            <form action="<?php echo e(url('/terms-and-conditions?form-id='.$id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="unique_id" value= "<?php echo $id; ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\policies\resources\views/frontend/create.blade.php ENDPATH**/ ?>