                ...
                <div class="col-md-12 text-center">
                    ...
                    <!-- <div id="page-icon">
                        <div class="pricing-icon">
                            <img src="<?php echo e(asset('images/service-icon1.svg')); ?>" alt="">
                        </div>
                    </div> -->
                </div>
            </div>
...
<div id="contact-info" class="container-fluid">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
            <form id="payment_form" action="<?php echo e(url('/bundle-billing?form-id='.$newunique)); ?>" method="post">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\policies\resources\views/policy/bundle.blade.php ENDPATH**/ ?>