  ...
  <div class="container">
    <div class="panel-group">
      <div class="panel panel-primary">
        <form action="<?php echo e(url('acceptable-use-policy-review?form-id='.$id)); ?>" method="post" id="multistep_form">
          <?php echo csrf_field(); ?>
          <div id="form1" class="tab">
            <?php if(isset($data) && auth()->user()->admin == '1' || isset($data) && auth()->user()->admin == '2'): ?>
            <input type="hidden" name="adminn" value="1"/>
            <?php else: ?> <input type="hidden" name="adminn" value="0"/> <?php endif; ?>
              ...
              <div class="form-group form_part">
                ...
                <div class="col-sm-4" style="display: flex;">
                  <select class="form-control form_font" id="c_id" name="c_id">
                    ...
                    <option value="<?php echo e($country->value); ?>"><?php echo e($country->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                  <?php $states = DB::table('state')->get(); ?>
                  <select class="form-control form_font d-none" id="s_id" name="s_id">
                    <option value="">Select State</option>
                    <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($state->value); ?>"><?php echo e($state->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
              ...
              <div class="premium hidden">
                  ...
                  <div class="row">
                      <div class="col-sm-6">
                          ...
                          <p class="no-margin-bottom">$<?php echo e($price->deal_price); ?>(one time payment, no recurring fees)</p>
                      </div>
                      <div class="col-sm-6">
                          <h5 class="">Looking for the best deal?</h5>
                          <p class="">Check out our <a href="<?php echo e(route('bundlebill')); ?>">discounted bundles</a></p>
                      </div>
                  </div>
              </div>
              <div class="basic hidden">
                <div class="alert alert-warning" role="alert">
                    FREE! Not suitable for commercial use (websites and apps that display ads, have affiliate links, or accept payments of any kind and for any purpose). See <a class="underline ul-red" target="_blank" href="<?php echo e(route ('pricing')); ?>">comparison table</a> for details.
                </div>
              </div>
            </div>
          </div>
...
<script src="<?php echo e(asset('asset/js/acceptable-policy.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\policies\resources\views/policy/acceptable-use-policy.blade.php ENDPATH**/ ?>