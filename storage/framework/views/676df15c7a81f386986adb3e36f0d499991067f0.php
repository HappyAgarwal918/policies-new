            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="page-title">
                        Disclaimer for <?php echo e($a->website_url); ?>
        ...
        <div class="card-body">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="View" role="tabpanel">
                ...
                <p>We recommend linking to your policy directly from your <?php if ($platforms == 'Website URL') {echo 'Website';} else {echo'Mobile Application';} ?>. We host it for free and it will ensure automatic updates and compliance with the latest requirements and regulations.</p>
                <h4 class="my-3">Public link to your policy</h4>
                <pre class="link"><code id="policy_html_link"><?php echo url('') ?>/disclaimer-premium-policy?form-id=<?php echo $id ?></code></pre>
                ...
                <a class="ybtn ybtn-header-color" target="_blank" href="<?php echo url('') ?>/disclaimer-premium-policy?form-id=<?php echo $id ?>" type="button">View policy</a>
            </div>
            ...
            <ul class="button_main">
                ...
                <li><a class="button btn-danger ybtn" href="<?php echo e(route('policydestroy',$id)); ?>" onclick="return confirm('Are you sure you want to Delete?');">Delete policy</a>
                </li>
            </ul>
          </div>
        </div>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\policies\resources\views/policy/auth/disclaimer_premium_policy.blade.php ENDPATH**/ ?>