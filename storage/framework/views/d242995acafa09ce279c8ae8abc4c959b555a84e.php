  ...
  <div class="container">
    <div class="panel-group">
      <div class="panel panel-primary">
        <form action="<?php echo e(url('/disclaimer-review?form-id='.$id)); ?>" method="post" id="multistep_form">
          <?php echo csrf_field(); ?>
...
<script src="<?php echo e(asset('asset/js/disclaimer-policy.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\policies\resources\views/policy/disclaimer.blade.php ENDPATH**/ ?>