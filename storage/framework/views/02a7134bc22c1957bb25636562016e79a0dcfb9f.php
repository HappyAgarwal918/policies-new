...
<div class="row">
    <div class="col-sm-12 col-lg-6">
        <div class="service-box">
            <div class="service-icon">
                <img src="<?php echo e(asset('images/acceptable-use-policy.png')); ?>" alt="">
            </div>
            <div>
                ...
                <div class="service-details">
                    ...
                    <div class="control actions">
                        <a class="ybtn ybtn-header-color p-0" href="<?php echo e(url('/add/policy?form-id=acceptable-use-policy')); ?>">Acceptable use policy</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="service-box">
            <div class="service-icon">
                <img src="<?php echo e(asset('images/cookie-policy.png')); ?>" alt="">
            </div>
            <div>
                ...
                <div class="service-details">
                    ...
                    <div class="control actions">
                        <a class="ybtn ybtn-header-color p-0" href="<?php echo e(url('/add/policy?form-id=cookie-policy')); ?>">Cookie policy</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="service-box">
            <div class="service-icon">
                <img src="<?php echo e(asset('images/disclaimer.png')); ?>" alt="">
            </div>
            <div>
                ...
                <div class="service-details">
                    ...
                    <div class="control actions">
                        <a class="ybtn ybtn-header-color p-0" href="<?php echo e(url('/add/policy?form-id=disclaimer')); ?>">Disclaimer</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="service-box">
            <div class="service-icon">
                <img src="<?php echo e(asset('images/dmca-policy.png')); ?>" alt="">
            </div>
            <div>
                ...
                <div class="service-details">
                    ...
                    <div class="control actions">
                        <a class="ybtn ybtn-header-color p-0" href="<?php echo e(url('/add/policy?form-id=dmca-policy')); ?>">DMCA policy</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="service-box">
            <div class="service-icon">
                <img src="<?php echo e(asset('images/privacy-policy.png')); ?>" alt="">
            </div>
            <div>
                ...
                <div class="service-details">
                    ...
                    <div class="control actions">
                        <a class="ybtn ybtn-header-color p-0" href="<?php echo e(url('/add/policy?form-id=privacy-policy')); ?>">Privacy policy</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="service-box">
            <div class="service-icon">
                <img src="<?php echo e(asset('images/refund-policy.png')); ?>" alt="">
            </div>
            <div>
                ...
                <div class="service-details">
                    ...
                    <div class="control actions">
                        <a class="ybtn ybtn-header-color p-0" href="<?php echo e(url('/add/policy?form-id=refund-policy')); ?>">Refund policy</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-12 col-lg-6">
        <div class="service-box">
            <div class="service-icon">
                <img src="<?php echo e(asset('images/terms-conditions.png')); ?>" alt="">
            </div>
            <div>
                ...
                <div class="service-details">
                    ...
                    <div class="control actions">
                        <a class="ybtn ybtn-header-color p-0" href="<?php echo e(url('/add/policy?form-id=terms-and-conditions')); ?>">Terms and conditions</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7\htdocs\policies\resources\views/admin/policy/newpolicy.blade.php ENDPATH**/ ?>